...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		CreateWindow(L"edit", NULL, WS_CHILD | WS_VISIBLE | WS_BORDER | CBS_AUTOHSCROLL, 10, 10, 100, 25, hWnd, (HMENU)3001, hInst, NULL);
    ...
    case WM_COMMAND:
        {
			...
			case 4002:
			{
				...
				TCHAR szOutput[256];
				swprintf_s(szOutput, 256, L"차는 %d", min);
			...
			case 4003:
			{
				...
				TCHAR szOutput[256];
				swprintf_s(szOutput, 256, L"곱은 %d", tim);
			...
			case 4004:
			{
				...
				TCHAR szOutput[256];
				swprintf_s(szOutput, 256, L"몫은 %d", div);
