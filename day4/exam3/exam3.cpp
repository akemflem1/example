    ...
    case WM_PAINT:
        {
			...
			SolidBrush brushGreen(Color(0, 255, 0)); //구체적으로 쓸수 있는 브러쉬 구분

			graphic.FillRectangle(&brushGreen, 100, 100, 200, 200); //채우기
			graphic.DrawRectangle(&redPen, 100, 100, 200, 200); //외곽선

			graphic.FillEllipse(&brushGreen, 300, 100, 200, 200);
			graphic.DrawEllipse(&redPen, 300, 100, 200, 200);
            EndPaint(hWnd, &ps);
        }
        break;
    case WM_DESTROY:
