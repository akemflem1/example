	...
	case WM_TIMER:
		{
			...
			int xPos = rand() % 500, yPos = rand() % 500, xSize = rand() % 200, ySize = rand() % 200;

			Pen pen(Color(rand() % 256, rand() % 256, rand() % 256), rand()%10);
			graPhics.DrawLine(&pen, xPos, yPos, xSize, ySize);
