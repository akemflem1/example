...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		...
		CreateWindow(L"button", L"click Me 2", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 20, 50, 100, 25, hWnd, (HMENU)3002, hInst, NULL);
	}
		break;
    case WM_COMMAND:
        {
			...
			Rectangle(hdc, rand() % 500, 200+ rand() % 300, rand() % 200, 200 + rand() % 200);
