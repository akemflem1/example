    ...
    case WM_PAINT:
        {
			...
			SetPixel(hdc, 100, 105, RGB(0, 51, 153));
			SetPixel(hdc, 101, 105, RGB(0, 51, 153));
			SetPixel(hdc, 102, 105, RGB(0, 51, 153));
			SetPixel(hdc, 103, 105, RGB(0, 51, 153));
			SetPixel(hdc, 104, 105, RGB(0, 51, 153));

			SetPixel(hdc, 100, 106, RGB(102, 0, 255));
			SetPixel(hdc, 101, 106, RGB(102, 0, 255));
			SetPixel(hdc, 102, 106, RGB(102, 0, 255));
			SetPixel(hdc, 103, 106, RGB(102, 0, 255));
			SetPixel(hdc, 104, 106, RGB(102, 0, 255));
