    ...
    case WM_PAINT:
        {
			...
			irr::core::vector2df vNewOrigin(160, 120);
			grp.TranslateTransform(vNewOrigin.X, vNewOrigin.Y); //vTest1 += vNewOrigin; vTest2 += vNewOrigin; 두개를 써준것같은 효과
			
			irr::core::vector2df vTest1(0,0);
			irr::core::vector2df vTest2(100,100);
						
			grp.DrawLine(&pen, vTest1.X, vTest1.Y, vTest2.X, vTest2.Y);
